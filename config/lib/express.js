...
module.exports.initValidLogin = function(app){
  app.use(function(req, res, next) {
    var url = req.url;
    console.log("经过了是否登录这个过滤器");
    if (url != '/' && url != '/api/users/signin'&& url != '/authentication/signin'
