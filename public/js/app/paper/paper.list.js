var PaperTableList = function($scope,$compile,params) {
    ...
    table.init = function () {
        ...
        $('#table').bootstrapTable({
            url: '/api/paper/getByPage',        //请求后台的URL(*)
            method: 'get',                                      //请求方式(*)
            toolbar:'toolBar',
                ...
                },
                {
                    ...
                    formatter: function(value,row,index){
                        ...
                        var event=
                            ...
                            "<button style='margin-right: 5px' class='btn btn-sm btn-success' title='试题查看' ng-click='mangerExercise("+'"'+value+'"'+")'>" +
                        "<span class='glyphicon glyphicon-eye-open'>试题查看</span></button>";
