var NoticeTableList = function($scope,$compile,params) {
            ...
            columns: [
                ...
                },
                {
                    ...
                    formatter: function(value,row,index){
                        ...
                        var event=
                            "<button style='margin-right: 5px' class='btn btn-sm btn-success' title='编辑' ng-click='edit("+'"'+value+'"'+")'>" +
                            "<span class='glyphicon glyphicon-edit'>编辑</span></button>"+
                            ...
                            "<button style='margin-right: 5px' class='btn btn-sm btn-success' title='详情' ng-click='showNotice("+'"'+value+'"'+")'>" +
                            "<span class='glyphicon glyphicon-eye-open'>详情</span></button>";
    ...
    table.initEvents = function(){
        ...
        $('#noticeTable').on('uncheck.bs.table check.bs.table check-all.bs.table uncheck-all.bs.table', function (e, rows,sourceRows) {
            var eType = e.type;
