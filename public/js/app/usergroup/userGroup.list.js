var UserGroupTableList = function($scope,$compile,params) {
    ...
    table.initEvents = function(){
        ...
        $('#userGroupTable').on('uncheck.bs.table check.bs.table check-all.bs.table uncheck-all.bs.table', function (e, rows,sourceRows) {
            var eType = e.type;
