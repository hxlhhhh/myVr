var examTableList = function($scope,$compile,params) {
                ...
                },
                 {
                    ...
                    formatter: function(value,row,index){
                        ...
                        var event=
                            ...
                            "<button class='btn btn-sm btn-success' title='' ng-click='publishExam("+'"'+value+'"'+")'>" +
                            "<span class='glyphicon glyphicon-retweet'>发布考试</span></button>";
    ...
    table.queryParam = function(reqParam){
        ...
        resParams['subject'] = params['subject'];
        return resParams;
    }
