var ExerciseTableList = function($scope,$compile,params) {
    ...
    table.init = function () {
        ...
        $('#table').bootstrapTable({
            url: '/api/exercises/getByPage',        //请求后台的URL(*)
            method: 'get',                                      //请求方式(*)
            toolbar:'toolBar',
                ...
                },
                {
                    ...
                    formatter: function(value,row,index){
                        ...
                        var event=
                            ...
                            "<button style='margin-right: 5px' class='btn btn-danger' title='删除' ng-click='delete("+'"'+value+'"'+")'>" +
